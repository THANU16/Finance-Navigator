  ...
  res.json(
    assets.map((a) => {
      ...
      return {
        ...
        absoluteReturn: a.returnAmount,
        absoluteReturnPercent: a.returnPercent,
        cagr: a.cagr,
        xirr: a.xirr,
...
router.get("/:id", async (req, res): Promise<void> => {
  ...
  res.json({
    ...
    absoluteReturn: metrics?.returnAmount ?? 0,
    absoluteReturnPercent: metrics?.returnPercent ?? 0,
    cagr: metrics?.cagr ?? null,
    xirr: metrics?.xirr ?? null,
    targetPercent: Number(asset.targetPercent),
    actualPercent: 0,
    currency: asset.currency,
    isActive: asset.isActive,
