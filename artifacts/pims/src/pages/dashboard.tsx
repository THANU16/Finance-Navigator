  ...
  const handleRecalculate = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "All values have been recomputed from your transactions and valuations.",
      });
    } finally {
        ...
        <div className="space-y-2">
          {alerts.map((alert) => (
            ...
            >
              ...
              <AlertTitle className="uppercase tracking-wider text-xs font-semibold">
                {alert.type}
              </AlertTitle>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground mt-1 flex items-center gap-1">
              Invested: {formatCurrency(summary.investedValue.assets)}
            </div>
            <div className="text-xs text-muted-foreground mt-1 flex items-center gap-1">
              Cash: {formatCurrency(summary.investedValue.cash)}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div
              className={`text-xs mt-1 flex items-center gap-1 ${summary.profitLossPercent >= 0 ? "text-green-500" : "text-red-500"}`}
            >
        ...
        <Card>
          ...
          <CardContent>
            ...
            >
              <span
                className={
                  summary.monthlyReturn >= 0 ? "text-green-500" : "text-red-500"
                }
              >
                {summary.monthlyReturn >= 0 ? "+" : ""}
                {formatCurrency(summary.monthlyReturn)}
              </span>
            </div>
            <div
              className={`text-xs mt-1 flex items-center gap-1 ${summary.monthlyReturnPercent >= 0 ? "text-green-500" : "text-red-500"}`}
            >
              {summary.monthlyReturnPercent >= 0 ? (
                <ArrowUpRight className="h-3 w-3" />
              ) : (
                <ArrowDownRight className="h-3 w-3" />
              )}
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Target: {formatCurrency(summary.emergencyFundRequired)}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-end">
                <div>
                  <div className="text-3xl font-bold">
                    {formatCurrency(summary.emergencyFundCurrent)}
                  </div>
              ...
              <Progress
                ...
                className="h-3"
                indicatorClassName={
                  summary.emergencyFundPercent < 50
                    ? "bg-red-500"
                    : summary.emergencyFundPercent < 80
                      ? "bg-yellow-500"
                      : "bg-green-500"
                }
              />
