...
export const sipConfigsTable = pgTable("sip_configs", {
  ...
  equityPercent: numeric("equity_percent", { precision: 5, scale: 2 })
    .notNull()
    .default("60"),
  debtPercent: numeric("debt_percent", { precision: 5, scale: 2 })
    .notNull()
    .default("20"),
  metalsPercent: numeric("metals_percent", { precision: 5, scale: 2 })
    .notNull()
    .default("10"),
  opportunityPercent: numeric("opportunity_percent", { precision: 5, scale: 2 })
    .notNull()
    .default("10"),
  assetAllocations: jsonb("asset_allocations").notNull().default([]),
  opportunityAllocations: jsonb("opportunity_allocations")
    .notNull()
    .default([]),
